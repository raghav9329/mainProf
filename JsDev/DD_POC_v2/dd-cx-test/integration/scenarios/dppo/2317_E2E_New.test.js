...
var tData = require('../../testData/' + testDataEnv + '/dppo/dppo.2317_E2E_New.json');

var pdf2Text = require('pdf2text')

// var product = ['DPPO']
    // var product = ['AARPPPO']
    var product = ['AARPPPO', 'DPPO']
    ...
    if (product.indexOf(description) != -1) {
        ...
        describe('DPPO:2317_E2EPayCCAnn_TwoDep', function() {
            ...
            it('E2E_2 :should populate PersInfo page', function() {
                if (description == 'AARPPPO') TestData.MemberId = Utility.randomNo('Number', 10);
                perInfo.fillPersonalInfo(TestData);
                perInfo.fillAddress(TestData);
                perInfo.phoneNumberemail(TestData);
                if (description == 'AARPPPO') {
            ...
            it('E2E_4 :should fill out pay details', function() {
                ...
                if (description == 'AARPPPO') payment.frequencyAnnualy.select();
            ...
            it('E2E_5 :Should submit delta rating', function() {
                ...
                expect(receipt.totalPaid.getText()).toEqual(TestData.totalpaid);
