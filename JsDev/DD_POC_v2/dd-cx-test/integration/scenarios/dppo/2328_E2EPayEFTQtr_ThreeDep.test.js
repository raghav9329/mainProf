...
// var states = ['CA']; Shounak: Not required. Specify / set the states in Config file.
    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function (tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                ...
                describe('DPPO:2328_E2EPayEFTQtr_ThreeDep:State:' + sdescription + 'Product:' + pdescription + '', function () {
                    ...
                    it('E2E_9:Should display dependent-2 applicant', function () {
                        ...
                        receipt.getSelectedFacilityDetails('DEPENDENT', 2).then(function (facilitydata) {
                            ...
                            Utility.readPDFFile(pathToPdf).then(function (test) {
                                expect(test).toContainPdfFile(TestData.firstname);
