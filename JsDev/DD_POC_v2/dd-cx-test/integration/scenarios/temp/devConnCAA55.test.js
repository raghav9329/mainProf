...
//		var url = protocol.concat(testServer, '.', testDomain_Name);
		...
		server = host_dit3;
		//browser.get(url );
		browser.get('https://aw-lx0076.deltadev.ent:3000/enroll');
		//console.log('starting: CAA54IndividualAnfFamily.test.js');
		console.log('starting at:  devConnCAA55.test.js');
	...
	it('it Parent Describe: Senior plan workflow',function(){
		console.log('it Parent Describe Start:  devConnCAA55***.test.js');
	});
	...
	//	var getAQuote_Button = element(by.css('.button'));
		var getAQuote_Button = element(by.id('enrollId'));
