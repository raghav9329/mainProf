...
var TestData = require('../../testData/aarpppo/aarpppo.XXXXPayment_Monthly_ThreeDep_WrkFlow.json');

describe('PPO :aarpppo.XXXXPayment_Monthly_ThreeDep_WrkFlow', function() {
    var effectedDate;
    beforeAll(function() {
        console.log(' ');
