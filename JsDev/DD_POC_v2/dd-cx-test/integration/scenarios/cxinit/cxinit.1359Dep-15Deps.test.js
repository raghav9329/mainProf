...
var TestData = require("../../testData/cxinit/cxinit.1359Dep-15Deps.test.json");
var perInfo = new(require('../../pageObjects/cxinit/perInfo-page.js'));
var depInfo = new(require('../../pageObjects/cxinit/dependent-page.js'));
var enrollPage = new(require('../../businessComponents/homePage.js'));

describe('CXINIT-1359: 15 Dependents Max ', function() {
    beforeAll(function() {
    ...
    it('Dependents Max_Step_3: Verifying and Validate the Dependents of same type(Domestic Partner and Spouse do not allowed) not allowed more than 1', function() {
        ...
        expect(depInfo.errorGender('Dependent1').getText()).toEqual("Please select a gender");
        Utility.scrollToTop();
