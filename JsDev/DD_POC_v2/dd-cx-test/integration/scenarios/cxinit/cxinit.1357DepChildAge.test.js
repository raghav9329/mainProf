 ...
 */
var TestData = require("../../testData/cxinit/cxinit.1357DepChildAge.json");
...
describe('CXINIT-1357: Dependents childs Age', function() {
    ...
    // Fill the dependent with child and the age af the child is more than 26
    ...
    it('Step-3:Should display the handicapped check box with help text', function() {
        ...
        expect(depInfo.handicappedHelpTxt('Dependent1').getText()).toEqual(TestData.handicappedHelpText);
    });
    ...
    it('Step-5:Handicapped check box should be display for second dependent', function() {
        ...
        expect(depInfo.handicappedHelpTxt('Dependent2').getText()).toEqual(TestData.handicappedHelpText);
    });
