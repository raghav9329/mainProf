            ...
            if (product.indexOf(pdescription) != -1) {
                ...
                describe('1753 Direct_HMO WorkFlows_4 : ||State:' + sdescription + '||Product:' + pdescription + '||', function() {
                    ...
                    it('E2E_7 :Should submit delta rating', function() {
                        ...
                        expect(receipt.planPurchased.getText()).toContain(tData.planName,'Verify "Purchased Plan" name is same as: ' +tData.planName);
                    ...
                    if (pdescription == 'DHMO' || pdescription == 'AHMO') {
                        ...
                        it('E2E_11:Should display dependent-2 applicant', function() {
                            ...
                            receipt.getSelectedFacilityDetails('DEPENDENT', 2).then(function(facilitydata) {
                                ...
                                expect(facilitydata.facilityName).toEqual(facility.facilityName,'Verify the "facilityName" field value of Dependent-2 Facility is same as: ' +facility.facilityName);
                                expect(facilitydata.street).toEqual(facility.street,'Verify the "street" field value of Dependent-2 Facility is same as: ' +facility.street);
                                expect(facilitydata.city).toEqual(facility.city,'Verify the "city" field value of Dependent-2 Facility is same as: ' +facility.city);
                                expect(facilitydata.region).toEqual(facility.region,'Verify the "region" field value of Dependent-2 Facility is same as: ' +facility.region);
                                expect(facilitydata.postalCode).toContain(facility.postalCode,'Verify the "postalCode" field value of Dependent-2 Facility is same as: ' +facility.postalCode);
                                expect(facilitydata.telephone).toEqual(facility.telephone,'Verify the "telephone" field value of Dependent-2 Facility is same as: ' +facility.telephone);
                        ...
                        it('E2E_12:Should display dependent-3 applicant', function() {
                            ...
                            receipt.getSelectedFacilityDetails('DEPENDENT', 3).then(function(facilitydata) {
                                expect(facilitydata.name).toContain(TestData.child2.firstName,'Verify the "First Name" field value of Dependent-3 Facility is same as: ' +TestData.child2.firstName);
                                expect(facilitydata.facilityName).toEqual(facility.facilityName,'Verify the "facilityName" field value of Dependent-3 Facility is same as: ' +facility.facilityName);
                                expect(facilitydata.street).toEqual(facility.street,'Verify the "street" field value of Dependent-3 Facility is same as: ' +facility.street);
                                expect(facilitydata.city).toEqual(facility.city,'Verify the "city" field value of Dependent-3 Facility is same as: ' +facility.city);
                                expect(facilitydata.region).toEqual(facility.region,'Verify the "region" field value of Dependent-3 Facility is same as: ' +facility.region);
                                expect(facilitydata.postalCode).toContain(facility.postalCode,'Verify the "postalCode" field value of Dependent-3 Facility is same as: ' +facility.postalCode);
                                expect(facilitydata.telephone).toEqual(facility.telephone,'Verify the "telephone" field value of Dependent-3 Facility is same as: ' +facility.telephone);
