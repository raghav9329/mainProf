...
dataProvider(TestData.products, function(tData, description) {
    if (product.indexOf(description) != -1) {
        describe('DHMO:507: PersInfoPg: ', function() {
            ...
            it('507PI 2:should show fields are displayed', function() {
                ...
                if (description == 'DHMO' || description == 'DPPO') expect(perInfo.fieldSsn.isPresentAndDisplayed()).toBeTruthy();
                if (description == 'DHMO' || description == 'DPPO') expect(perInfo.fieldAlternateId.isPresentAndDisplayed()).toBeTruthy();
                if (description == 'AHMO' || description == 'APPO') expect(perInfo.memberId.isPresentAndDisplayed()).toBeTruthy();
            ...
            if (description == 'DHMO' || description == 'DPPO') {
            ...
            if (description == 'AHMO' || description == 'APPO') {
                ...
                if (data.ExecutionFlag) {
                    it('507PI 14X: Eval Gender selected value "' + data.Gender + '"', function() {
                        if (data.Gender.length > 1) {
                            if ((description == 'AHMO' || description == 'APPO') && (des !== 'Gender_NonBinary')) perInfo.fieldGenderSelect.selectByText(data.Gender);
                        }
                        perInfo.next.click();
                        browser.sleep(minWait);
                        browser.executeScript('window.scrollTo(0,0);');
