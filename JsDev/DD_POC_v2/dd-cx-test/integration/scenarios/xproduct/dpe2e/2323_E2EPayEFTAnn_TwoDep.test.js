    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function(tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                ...
                describe('2323_E2EPayEFTAnn_TwoDep:State:' + sdescription + 'Product:' + pdescription + '', function() {
                    ...
                    it('E2E_4 :should fill out pay details', function() {
                        ...
                        payment.next.click();
                        expect(payment.bankNameError.getText()).toEqual(TestData.bankNameError,'Verify Bank Name Error Message is same as: ' +TestData.bankNameError);
                        expect(payment.accountHolderNameError.getText()).toEqual(TestData.accountHolderNameError,'Verify Account Holder field Error message is same as: ' +TestData.accountHolderNameError);
                        expect(payment.routingNumberError.getText()).toEqual(TestData.routingNumberError,'Verify Routing Number field Error message is same as: ' +TestData.routingNumberError);
                        expect(payment.accountNumberError.getText()).toEqual(TestData.accountNumberError,'Verify Account Number field Error Message is same as: ' +TestData.accountNumberError);
