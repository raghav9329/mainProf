    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function (tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                describe('2092_E2EPayAnn_TwoDep: State:' + sdescription + 'Product:' + pdescription + '', function () {
                    var effectedDate;
                    beforeAll(function () {
                        console.log(' ');
                    ...
                    it('E2E_1 : Should complete the Enroll Page', function () {
                        enrollPage.enterHomePageDetails(tData.enrollData).then(function (effectDate) {
                        ...
                        // enrollPage.enterHomePageDetailsNew(TestData.enrollData);
                    });
                    ...
                    it('E2E_5 :Should submit delta rating', function () {
                        ...
                        expect(receipt.planPurchased.getText()).toContain(TestData.planName,'Verify "Purchased Plan" name is same as: ' +tData.planName);
                        expect(receipt.effectiveDate.getText()).toEqual(effectedDate,'Verify Effective Date in Displayed and Present in the receipt page is same as: ' +effectedDate);
                        expect(receipt.totalPaid.getText()).not.toEqual('$0.00','Verify Total premium amount paid is same as: "$0.00" ');
