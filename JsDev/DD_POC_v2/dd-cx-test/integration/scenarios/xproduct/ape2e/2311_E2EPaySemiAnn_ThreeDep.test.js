...
var TestData       = require('../../../testData/' + testDataEnv + '/aarpppo/aarpppo.2311_E2EPaySemiAnn_ThreeDep.json');
    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function (tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                ...
                describe('2311_E2EPaySemiAnn_ThreeDep: State:' + sdescription + 'Product:' + pdescription + '', function () {
                    var effectedDate;
                    beforeAll(function () {
                        console.log(' ');
                    ...
                    it('E2E_4 :should fill out pay details', function () {
                        ...
                        payment.frequencySemiAnnual.select();
