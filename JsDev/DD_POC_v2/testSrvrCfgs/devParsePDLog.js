var results = require('c:/cx/pdMot_results.json');
...
console.log("<thead><tr><th> Total Tests " + total +",<br\>Total Pass " + testPass + ",<br\>Total Fail " + testFails + ",<br\> Duration  " + totalDuration + " Minutes" );
