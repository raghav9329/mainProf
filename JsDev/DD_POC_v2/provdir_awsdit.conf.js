exports.config = {
    ...
    suites: {
    	...
    	facs:[
    		'integration/scenarios/cxinit/cxinit.1365FacSearch.test.js',
	...
	pd1145: [
		'integration/scenarios/providers/cxinit2-1145.test.js',
	],
	pd1146: [
...
//	console.error('just someoutput text at the end !!!!');
////	process.exit(1);
//}
