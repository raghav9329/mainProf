 ...
 * This Script Validates the functionality of dependents with Spouse and Domestic Partner 
 * System will allow only one spouse or one domestic partner
 */
var TestData = require("../../testData/cxinit/cxinit.1358DepSpouse-DP.json");
...
describe('CXINIT-1358: Dependents - Spouse&DomesticPartner ', function() {
    var dep2_Price;
    beforeAll(function() {
    ...
    it('Step-4:Verify that Premium Change popup displayed when added one dependent', function() {
        ...
        // Bug- Remove following two lines of code
        //CXINIT-1372 Extra Dependent block is adding when two dependents have spouse or Domestic Partner
        Utility.scrollToTop();
        browser.sleep(6000);
    ...
    it('Step-5:Verify the price in purple box', function() {
        ...
        depInfo.newAdditionalPrice.getText().then(function(dep2Price) {
            ...
            facilities.premiumAmount.getText().then(function(premium) {
                expect(premium.substring(1)).toEqual(dep2Price);
