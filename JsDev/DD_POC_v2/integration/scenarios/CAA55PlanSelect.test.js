...
//		server = host_dit3;  2/13/ commented out for check to see if used anywhere ???
		browser.get(url );
	});
	...
	describe('Start the Plan Selection Process via Get A Quote Button', function() {
		...
		//var getAQuote_Button = element(by.id('apply'));// 2/13/17 testing differenc selector
...
/* 2/14/17 in consideration for removal.  this plan and senior plan */		
