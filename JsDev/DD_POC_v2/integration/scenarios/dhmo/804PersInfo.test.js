    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function(tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                describe('DHMO:804: Zip Code Popup validation', function() {
                    ...
                    it('Verify the functionality of Go Back link in Zip code pop Up while Updating Home address', function() {
                        perInfo.fieldHomeAddr.setText(tData.HAddress_ZIP.PartialAddress);
                        perInfo.selectHomeAddress(tData.HAddress_ZIP.FullAddress);
                        ...
                        expect(perInfo.fieldState.getAttribute("value")).toEqual(tData.Address_Valid.State);
                        expect(perInfo.fieldCity.getAttribute("value")).toEqual('');
                        expect(perInfo.fieldZipCode.getAttribute("value")).toEqual(tData.ZipCode);
                    });
                    ...
                    it('Verify the functionality of New Quote button in Zip code pop Up while Updating Home address', function() {
                        ...
                        expect(browser.getTitle()).toContain(tData.Title);
                    });
                    ...
                    it('Verify the functionality of Go Back link in Zip code pop Up while changing zip code', function() {
                        perInfo.fieldHomeAddr.setText(tData.Address_Valid.HomeAddress);
                        perInfo.fieldState.setText(tData.Address_Valid.State);
                        perInfo.fieldCity.setText(tData.Address_Valid.City);
                        perInfo.fieldZipCode.setText(tData.ZipCode2);
                    ...
                    it('Verify the functionality of New Quote button in Zip code pop Up while changing zip code', function() {
                        perInfo.fieldHomeAddr.setText(tData.Address_Valid.HomeAddress);
                        perInfo.fieldState.setText(tData.Address_Valid.City);
                        perInfo.fieldCity.setText(tData.Address_Valid.State);
                        perInfo.fieldZipCode.setText(tData.ZipCode2);
                        perInfo.fieldPhoneNumber.setText('');
                        expect(perInfo.zipPopNewQuote.isPresentAndDisplayed()).toBeTruthy();
                        expect(perInfo.zipPopBack.isPresentAndDisplayed()).toBeTruthy();
