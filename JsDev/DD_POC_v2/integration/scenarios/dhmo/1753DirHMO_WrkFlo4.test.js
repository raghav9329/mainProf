            ...
            if (product.indexOf(pdescription) != -1) {
                ...
                describe('DHMO:1753 Direct_HMO WorkFlows_4 : ' + sdescription + 'Product:' + pdescription + '', function() {
                    ...
                    it('E2E_3 :should add 3 Dependents, 2 child and DM', function() {
                        ...
                        browser.sleep(10000);
                        if (sdescription == 'NY') {
                            depInfo.year('Dependent3').setText(Utility.getDatePart(moment().subtract(13, 'years').format('MM-DD-YYYY'), 'YEAR'))
                        } else {
                            expect(depInfo.isHandicapped('Dependent3').isPresentAndDisplayed()).toBeTruthy();
                            expect(depInfo.handicappedHelpTxt('Dependent3').getText()).toContain(TestData.handicappedHelpText);
                        }
                        if (sdescription == 'NY') {
                            depInfo.next.click();
                        } else {
                            depInfo.isHandicapped('Dependent3').check();
                        }
                        depInfo.next.click();
