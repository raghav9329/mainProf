var TestData = require('../../testData/' + testDataEnv + '/dhmo/Prod_DHMO.json');
...
describe('Prod_DHMO', function() {
    ...
    afterAll(function() {
        ...
        var file_path = './integration/testData/' + testDataEnv + '/dhmo/Prod_DHMO.json';
    ...
    it('Prod_DHMO_1: Enter the Zip code and Click on the Enter for the Enroll Page', function() {
    ...
    it('Prod_DHMO_2: Verify Personal Information Page is filled with Valid data and Proceed', function() {

        TestData.dob = moment().subtract(45, 'years').format('MM-DD-YYYY');
    ...
    it('Prod_DHMO_3: Verifying the Errors of both client and server side by passing NULL values', function() {
    ...
    it('Prod_DHMO_4: Verify 2 dependents were added and furnished with valid Test Data for Each of them', function() {
    ...
    it('Prod_DHMO_5: Verify and select a Facility for the primary', function() {
        facilities.selectFacility(TestData.facilityoption1);
        facilities.next.click();
    });

    it('Prod_DHMO_5_1: Verify and select the facilities for dependents', function() {
        facilities.selectFacility(TestData.facilityoption2);
        facilities.next.click();
    });

    it('Prod_DHMO_5_2: Verify and select the facilities for dependents', function() {
        facilities.selectFacility(TestData.facilityoption3);
        facilities.next.click();
        expect(browser.getTitle()).toEqual(TestData.paymentTitle);
    });

    it('Prod_DHMO_6: Validate and Verify the Errors of both the Client and Server in the Payment Page', function() {
    ...
    it('Prod_DHMO_7 :Should display plansummary', function() {
