...
var TestData = require('../../testData/aarpppo/aarpppo.XXXXPayment_Monthly_TwoDep_WrkFlow.json');

describe('PPO:aarpppo.XXXXPayment_Monthly_TwoDep_WrkFlow', function() {
    var effectedDate;
    beforeAll(function() {
        console.log(' ');
    ...
    it('E2E_5 :Should submit delta rating', function() {      
        ...
        expect(receipt.totalPaid.getText()).toEqual('$273.22');
