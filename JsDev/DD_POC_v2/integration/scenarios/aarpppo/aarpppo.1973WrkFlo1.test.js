...
var TestData = require('../../testData/aarpppo/aarpppo.1973WrkFlow1.json');

describe('PPO :1973 Work Flow', function() {
    var effectedDate;
    beforeAll(function() {
        console.log(' ');
    ...
    it('E2E_3 :should add 3 Dependents, 2 child and DM', function() {
        ...
        depInfo.fillDependent('Dependent4', TestData.child2, false);
        depInfo.next.click();
