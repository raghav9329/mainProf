...
var TestData = require('../../testData/' + testDataEnv + '/dppo/dppo.2318_E2EPayCCAnn_ThreeDep.json');
var product = ['DPPO'];
    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function (tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                ...
                describe('DPPO:2318_E2EPayCCAnn_ThreeDep:State:' + sdescription + 'Product:' + pdescription + '', function () {
                    ...
                    it('E2E_1 : Should complete the Enroll Page', function () {
                        ...
                        TestData.ssn = Utility.randomNo('Number', 9);
                    ...
                    it('E2E_5 :Should submit delta rating', function () {
                        ...
                        expect(receipt.totalPaid.getText()).toEqual(tData.totalpaid);
