//CXINTI-2565 :: Test Automation for DPPO Texas End to End
//Tx buyer must be 19 and disabled age is 25
...
describe('DPPO_TX:2565_E2EPayCCAnn_TwoDep work flow', function() {
    ...
    it('E2E_3 :should add 3 Dependents, 2 child and Spouse', function() {
        ...
        depInfo.next.click();
        if (depInfo.isHandicapped('Dependent3').isPresentAndDisplayed()) {
