//AARP-1746 : Receipt page verification
...
var TestData = require('../../testData/'+testDataEnv+'/aarphmo/aarphmo.2059AarpHMO_WrkFlow1.json');

//describe(totalDateString+'AARP HMO WorkFlows -1', function() {
describe('AARPHMO:2059 AARP HMO WorkFlows1', function() {
    ...
    it('E2E_8 :Should display plansummary', function() {
        ...
        console.log('2059_8 complete');
    });
    it('E2E_9 :Should display primary apllicant', function() {
