            ...
            if (product.indexOf(pdescription) != -1) {
                describe('507: PersInfoPg: for state: ||State:' + sdescription + '||Product:' + pdescription + '||', function() {
                    ...
                    it('507PI 17:Validate Next month is Birthday ', function() {
                        ...
                        expect(perInfo.errMsgBdYyyy.getText()).toContain('You must be at least 18 years of age');
                    ...
                    it('507PI 18:Validate Last Month was Birthday ', function() {
                        ...
                        perInfo.fieldHomeAddr.setText('');
                        expect(perInfo.fieldBdMM.getAttribute("class")).not.toContain(TestData.ariainvalid_error);
                        expect(perInfo.fieldBdDD.getAttribute("class")).not.toContain(TestData.ariainvalid_error);
                        expect(perInfo.fieldBdYyyy.getAttribute("class")).toContain(TestData.ariainvalid_success);
