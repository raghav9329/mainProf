                ...
                if (product.indexOf(pdescription) != -1) {
                    describe('507: PersInfoPg: for state: ||State:' + sdescription + '||Product:' + pdescription + '||', function() {
                            ...
                            it('507PI 2:should show fields are displayed', function() {
                                expect(perInfo.fieldFirstName.isPresentAndDisplayed()).toBeTruthy('Verify that "First Name" field is displayed');
                                expect(perInfo.fieldMidInitial.isPresentAndDisplayed()).toBeTruthy('Verify that "Middle Initaial" field is displayed');
                                expect(perInfo.fieldLastName.isPresentAndDisplayed()).toBeTruthy('Verify that "Last Name" field is displayed');
                                expect(perInfo.fieldGenderSelect.isPresentAndDisplayed()).toBeTruthy('Verify that "Gender" field is displayed');
                                expect(perInfo.fieldBdMM.isPresentAndDisplayed()).toBeTruthy('Verify that "Month" field is displayed');
                                expect(perInfo.fieldBdDD.isPresentAndDisplayed()).toBeTruthy('Verify that "Date" field is displayed');
                                expect(perInfo.fieldBdMM.isPresentAndDisplayed()).toBeTruthy('Verify that "Month" field is displayed');
                                expect(perInfo.fieldBdYyyy.isPresentAndDisplayed()).toBeTruthy('Verify that "Year" field is displayed');
                                if (pdescription == 'DHMO' || pdescription == 'DPPO') expect(perInfo.fieldSsn.isPresentAndDisplayed()).toBeTruthy('Verify that "SSN" field is displayed');
                                if (pdescription == 'DHMO' || pdescription == 'DPPO') expect(perInfo.fieldAlternateId.isPresentAndDisplayed()).toBeTruthy('Verify that "Alternate Id" field is displayed');
                                if (pdescription == 'AHMO' || pdescription == 'APPO') expect(perInfo.memberId.isPresentAndDisplayed()).toBeTruthy('Verify that "Member ID" field is displayed');
                                expect(perInfo.fieldPhoneSelect.isPresentAndDisplayed()).toBeTruthy('Verify that "Phone Select" dropdown is displayed');
                                expect(perInfo.fieldPhoneNumber.isPresentAndDisplayed()).toBeTruthy('Verify that "Phone Number" field is displayed');
                                expect(perInfo.fieldEmailAddr.isPresentAndDisplayed()).toBeTruthy('Verify that "Email Address" field is displayed');
                                expect(perInfo.next.isPresentAndDisplayed()).toBeTruthy('Verify that "Next" Button is displayed');
                            ...
                            it('507PI 3:First Name Click in tab-out', function() {
                                ...
                                expect(perInfo.errMsgFirstName.getText()).toEqual(TestData.ErrorMsgBlank_FirstName, 'Verifies that "First Name Error Message Should be' + TestData.ErrorMsgBlank_FirstName);
                                expect(perInfo.fieldFirstName.getAttribute("class")).toContain(TestData.ariainvalid_error, 'Verify that "First Name" field will be highlited with Red Colour');
                            ...
                            it('507PI 4:Middle Initial Click in tab-out', function() {
                                ...
                                expect(perInfo.fieldMidInitial.getValue()).toEqual(TestData.MName, 'Verify that "MidInitial" Should be: ' + TestData.MName);
                                expect(perInfo.fieldMidInitial.getAttribute("class")).toContain(TestData.ariainvalid_success, 'Verify that "Midial Initial" should be success');
                            ...
                            it('507PI 5:Last Name Click in tab-out', function() {
                                ...
                                expect(perInfo.errMsgLastName.getText()).toEqual(TestData.ErrorMsgBlank_LastName, 'Verify that "Last Name" field error should be' + TestData.ErrorMsgBlank_LastName);
                                expect(perInfo.fieldLastName.getAttribute("class")).toContain(TestData.ariainvalid_error, 'Verify that Last Name filed highlited with Red Colour');
                            ...
                            if (pdescription == 'DHMO' || pdescription == 'DPPO') {
                                it('507PI 7:SSN Click in tab-out', function() {
                                    ...
                                    expect(perInfo.errMsgSsn.getText()).toEqual(TestData.ErrorMsgBlank_SSN, 'Verify that "SSN" filed error message should be');
                                    expect(perInfo.fieldSsn.getAttribute("class")).toContain(TestData.ariainvalid_error, 'Verify that "SSN" highlited with Red Colour');
                                ...
                                it('507PI 8:AlternateID Click in tab-out', function() {
                                    perInfo.fieldAlternateId.setText('');
                                    perInfo.fieldFirstName.setText('');
                                    expect(perInfo.fieldAlternateId.getAttribute("class")).toContain(TestData.ariainvalid_success, 'Verify that "Alternate Id" is Success');
                            ...
                            if (pdescription == 'AHMO' || pdescription == 'APPO') {
                                it('507PI 7:Member ID Click in tab-out', function() {
                                    ...
                                    perInfo.fieldHomeAddr.setText('');
                                    expect(perInfo.errMsgMemberId.getText()).toEqual(TestData.ErrorMsgBlank_MemberID, 'Verify that "Mmber Id" error message should be ' + TestData.ErrorMsgBlank_MemberID);
                                    expect(perInfo.memberId.getAttribute("class")).toContain(TestData.ariainvalid_error, 'Verify that Member Id Highlighted with Red Colour');
                                    console.log('507PI 7: Complete')
                                });
                            }
                            ...
                            dataProvider(TestData.FName_TestData, function(data, description) {
                                if (data.ExecutionFlag) {
                                    it('507PI 9X:Eval FName: "' + data.FName + '"', function() {
                                        ...
                                        perInfo.fieldMidInitial.setText('');
                                        expect(perInfo.errMsgFirstName.getText()).toEqual(data.ErrorMsg, 'Verify that "First Name" error message should be ' + data.ErrorMsg);
                                        browser.executeScript('window.scrollTo(0,0);');
                                        expect(perInfo.fieldFirstName.getAttribute("class")).toContain(data.ariainvalid, 'Verify that First Name Highlighted with Red Colour');
                            ...
                            it('507PI 10: Validate ErrMsg Click Navigation, FirstName :- "' + TestData.FName_TestData.FName_Name11[0].FName + '"', function() {
                                ...
                                expect(perInfo.fieldFirstName.getAttribute("class")).toContain(TestData.FName_TestData.FName_Name11[0].ariainvalid, 'Verify that "First Name" Field Should Display Error Message with Alpha Numeric: ' + TestData.FName_TestData.FName_Name11[0].FName);
                            ...
                            dataProvider(TestData.MI, function(data, description) {
                                if (data.ExecutionFlag) {
                                    it('507PI 11X: Eval Mid Inital: "' + data.MI + '"', function() {
                                        ...
                                        perInfo.fieldLastName.setText('');
                                        expect(perInfo.fieldMidInitial.getValue()).toEqual(data.Expected, 'Verify that Mid Initial filed should be' + data.Expected);
                            ...
                            dataProvider(TestData.LName_TestData, function(data, description) {
                                if (data.ExecutionFlag) {
                                    it('507PI 12X: Eval LName: "' + data.LName + '"', function() {
                                        ...
                                        expect(perInfo.errMsgLastName.getText()).toEqual(data.ErrorMsg, 'Verify that Last Name error should be ' + data.ErrorMsg);
                                        browser.executeScript('window.scrollTo(0,0);');
                            ...
                            it('507PI 13: Validate ErrMsg Click Nav, LName :- "' + TestData.LName_TestData.LName_Name13[0].LName + '"', function() {
                                ...
                                expect(perInfo.fieldLastName.getAttribute("class")).toContain(TestData.LName_TestData.LName_Name13[0].ariainvalid, 'Verify that "First Name" Field Should Display Error Message with Alpha Special Chars:' + TestData.LName_TestData.LName_Name13[0].LName);
                            ...
                            it('507PI 15:Validate Today is Birthday ', function() {
                                ...
                                perInfo.fieldHomeAddr.setText('');
                                expect(perInfo.fieldBdMM.getAttribute("class")).toContain(TestData.ariainvalid_success, 'Verify that Month should be Success');
                                expect(perInfo.fieldBdDD.getAttribute("class")).toContain(TestData.ariainvalid_success, 'Verify that Date should be Success');
                                expect(perInfo.fieldBdYyyy.getAttribute("class")).toContain(TestData.ariainvalid_success, 'Verify that Year should be Success');
                            ...
                            it('507PI 16:Validating Tomorrow is Birthday ', function() {
                                    ...
                                    perInfo.fieldBdYyyy.setText(Utility.getDatePart(Utility.getfullDate('year', 'SUB', 18), 'YEAR'));
                                    perInfo.fieldHomeAddr.setText('');
                                    if (sdescription == 'NY' || sdescription == 'TX' || sdescription == 'AL') {
                                        expect(perInfo.errMsgBdYyyy.getText()).toEqual('You must be at least 19 years of age.', 'Verify that Error Message should be You must be at least 19 years of age.');
                                    } else {
                                        expect(perInfo.errMsgBdYyyy.getText()).toEqual('You must be at least 18 years of age.', 'Verify that Error Message should be You must be at least 18 years of age.');
                                    }
                        ...
                        it('507PI 17:Validate Next month is Birthday ', function() {
                            ...
                            if (sdescription == 'NY' || sdescription == 'TX' || sdescription == 'AL') {
                                expect(perInfo.errMsgBdYyyy.getText()).toContain('You must be at least 19 years of age', 'Verify that Error Message should be You must be at least 19 years of age.');
                            } else {
                                expect(perInfo.errMsgBdYyyy.getText()).toContain('You must be at least 18 years of age', 'Verify that Error Message should be You must be at least 18 years of age.');
                            }
                        ...
                        it('507PI 18:Validate Last Month was Birthday ', function() {
                            ...
                            perInfo.fieldHomeAddr.setText('');
                            expect(perInfo.fieldBdMM.getAttribute("class")).not.toContain(TestData.ariainvalid_error, 'Verify that Month should Invalid');
                            expect(perInfo.fieldBdDD.getAttribute("class")).not.toContain(TestData.ariainvalid_error, 'Verify that Date Should be Invalid');
                            expect(perInfo.fieldBdYyyy.getAttribute("class")).toContain(TestData.ariainvalid_success, 'Verify that Year Should be Success');
                        ...
                        dataProvider(TestData.DOB_invalid, function(data, description) {
                            if (data.ExecutionFlag) {
                                it('507PI 21X:Validate a DOB Invalid Leap Year"' + data.Leapyear + '"', function() {
                                    ...
                                    perInfo.fieldHomeAddr.setText('');
                                    expect(perInfo.birthdateerror.getText()).toContain(data.ErrorMsg, 'Verify that Birth Date Error Message Should be ' + data.ErrorMsg);
                        ...
                        dataProvider(TestData.DOB_invalidYear, function(data, description) {
                            if (data.ExecutionFlag) {
                                it('507PI 22X:Validate a DOB Invalid Leap Year"' + data.Leapyear + '"', function() {
                                    ...
                                    perInfo.fieldBdYyyy.setText(datesplit[2]);
                                    perInfo.fieldHomeAddr.setText('');
                                    expect(perInfo.errMsgYear.getText()).toContain(data.ErrorMsg, 'Verify that Error message of the Year should be ' + data.ErrorMsg);
                                    expect(perInfo.birthdateerror.getText()).toContain(data.ErrorMsg2, 'Verify that error message should be ' + data.ErrorMsg2);
                        ...
                        dataProvider(TestData.DOB_invalidYear_futuredate, function(data, description) {
                            if (data.ExecutionFlag) {
                                it('507PI 23X:Validate a DOB Invalid Leap Year"' + data.Leapyear + '"', function() {
                                    ...
                                    perInfo.fieldBdYyyy.setText(datesplit[2]);
                                    perInfo.fieldHomeAddr.setText('');
                                    expect(perInfo.errMsgYear.getText()).toContain(data.ErrorMsg, 'Verify that error message should be ' + data.ErrorMsg);
                            ...
                            if (data.ExecutionFlag) {
                                it('507PI 24X:Validate a DOB  meets Leap year with value"' + data.Leapyear + '"', function() {
                                    ...
                                    perInfo.fieldBdYyyy.setText(datesplit[2]);
                                    perInfo.fieldHomeAddr.setText('');
                                    expect(perInfo.fieldBdMM.getAttribute("class")).toContain(data.ariainvalid, 'Verify that Month should be Invalid');
                                    expect(perInfo.fieldBdDD.getAttribute("class")).toContain(data.ariainvalid, 'Verify that Date Should be invalid');
                                    expect(perInfo.fieldBdYyyy.getAttribute("class")).toContain(data.ariainvalid, 'Verify that Year should be Invalid');
                        ...
                        if (pdescription == 'DHMO' || pdescription == 'DPPO') {
                            ...
                            dataProvider(TestData.SSN, function(data, description) {
                                if (data.ExecutionFlag) {
                                    it('507PI 25X:Check SSN with value "' + data.SSN + '"', function() {
                                        ...
                                        browser.executeScript('window.scrollTo(0,0);');
                                        expect(perInfo.fieldSsn.getAttribute("class")).toContain(data.ariainvalid, 'Verify that SSN should be Invalid');
                            ...
                            it('507PI 26:Validate Error Msg Click Navigation, SSN :- "' + TestData.SSN.SSN4[0].SSN + '"', function() {
                                ...
                                expect(perInfo.fieldSsn.getAttribute("class")).toContain(TestData.SSN.SSN4[0].ariainvalid, 'Verify that SSN Should be Invalid');
                            ...
                            dataProvider(TestData.AlternateId, function(data, description) {
                                if (data.ExecutionFlag) {
                                    it('507PI 27X:Validate AlternateId field with value "' + data.AlternateId + '"', function() {
                                        ...
                                        expect(perInfo.fieldAlternateId.getAttribute("class")).toContain(TestData.ariainvalid_success, 'Verify that Alternate Id should be Success');
                        ...
                        if (pdescription == 'AHMO' || pdescription == 'APPO') {
                            ...
                            dataProvider(TestData.MemberID, function(data, description) {
                                if (data.ExecutionFlag) {
                                    it('Check MemberID with value "' + data.MemberID + '"', function() {
                                        ...
                                        perInfo.fieldHomeAddr.setText('');
                                        expect(perInfo.errMsgMemberId.getText()).toEqual(data.ErrorMsg, 'Verify that Member Id error message should be ' + data.ErrorMsg);
                                        browser.executeScript('window.scrollTo(0,0);');
                                        expect(perInfo.memberId.getAttribute("class")).toContain(data.ariainvalid, 'Veify that Member Id should be Invalid');
                                    });
                                };
                            });
                            ...
                            it('Validate Error Msg Click Navigation, MemberID :- "' + TestData.MemberID.MemberID4[0].MemberID + '"', function() {
                                ...
                                expect(perInfo.memberId.getAttribute("class")).toContain(TestData.MemberID.MemberID4[0].ariainvalid, 'Verify that Member Id should be Invalid');
                                perInfo.memberId.setText(TestData.MemberID.MemberID4[0].MemberID);
                            });
                        }
