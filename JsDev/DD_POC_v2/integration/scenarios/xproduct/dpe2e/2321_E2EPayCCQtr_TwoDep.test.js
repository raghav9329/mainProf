...
var TestData       = require('../../../testData/' + testDataEnv + '/dppo/dppo.2321_E2EPayCCQtr_TwoDep.json');
    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function(tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                describe('2321_E2EPayCCQtr_TwoDep:State:' + sdescription + 'Product:' + pdescription + '', function() {
