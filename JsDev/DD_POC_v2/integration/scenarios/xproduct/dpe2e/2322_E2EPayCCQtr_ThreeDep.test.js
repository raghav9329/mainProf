    ...
    if (states.indexOf(sdescription) != -1) {
        dataProvider(sData.products, function(tData, pdescription) {
            if (product.indexOf(pdescription) != -1) {
                ...
                describe('2322_E2EPayCCQtr_ThreeDep:State:' + sdescription + 'Product:' + pdescription + '', function() {
                    ...
                    it('E2E_9:Should display dependent-2 applicant', function() {
                        ...
                        receipt.getSelectedFacilityDetails('DEPENDENT', 2).then(function(facilitydata) {
                            ...
                            Utility.readPDFFile(pathToPdf).then(function(pdfdata) {
                                expect(pdfdata).toContain(TestData.firstname, 'Verify the "FirstName" field value displayed in the PDF is same as: ' + TestData.firstname);
