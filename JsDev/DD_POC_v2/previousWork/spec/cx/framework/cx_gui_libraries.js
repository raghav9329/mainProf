...
var cxGUILibraries = {
	...
	/**
	 * Navigate to specified page of CX Application.
	 *
	 ...
	 * @param {String} PlanIdentifier specific plan to enroll too.
	 * @param {String} Applicants number to enroll for the selected plan.
	 */
	navigateToPage : function(parameters) {
		...
		switch (parameters.Page)
		{
			...
			case Structures.Navigation.DITGetAQuote:
				...
				_cx['Environment'].planidentifier = (parameters.PlanIdentifier) ? parameters.PlanIdentifier : "70422";
				_cx['Environment'].applicants = (parameters.Applicants) ? parameters.Applicants : "1";
				if (parameters.DataCSS) {
					_cx['Environment'].applicants = (parameters.Applicants) ? parameters.Applicants : parameters.DataCSS.applicants;
					_cx['Environment'].planidentifier = (parameters.PlanIdentifier) ? parameters.PlanIdentifier : parameters.DataCSS.planidentifier;
 ...
 */
	...
	keyInDependentsFor : function(parameters) {
		...
		switch(parameters.Control) {
			...
			case Structures.Dependents.OnAlertBack:
			...
			case Structures.Dependents.OnAlertContinue: 
