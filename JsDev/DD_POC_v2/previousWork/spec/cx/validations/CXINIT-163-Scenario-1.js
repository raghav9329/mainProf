...
describe('CX : CXINIT-163 : End-to-End Validation - Delta Dental Plan Purchase', function() {
	...
	beforeEach(function() {
		if (!pageLoaded){
			/*
			*  CX : CXINIT-163 : SCENARIO 1 : STEP 1 : Get a Quote.
			*/
	...
	for (var index = 0; index < Data.cx.UseCases.length; index++ )
	{
		(function (applicant) {
			/*
			*  CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Personal Information Page : Enter applicant information.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Personal Information Page : Enter applicant information.', function() {
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Dependents Page : Add Dependents.
			*/
			for (var idependent = 0; idependent < applicant.NoPurchaseMade.Dependents.length; idependent++)
			{
				(function (dependent) {					
					it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Dependents Page : Add Dependents - ' + dependent.Relationship + ' ' + dependent.Name.First, function() {
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Facilities Page : Validate Facilities page is displayed.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Facilities Page : Validate Facilities page is displayed.', function() {	
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Facilities Page : Select a facility.
			*/
			for (var ifacility = 0; ifacility < applicant.NoPurchaseMade.Facilities.Identifiers.length; ifacility++)
			{
				(function (facility) {
					it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Facilities Page : Select a facility at location(' + ifacility + ')', function() {	
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Payments Page : Enter payment details.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Payments Page : Enter payment details.', function() {
			...
			/*
			*  CX : CXINIT-163 : SCENARIO 1 : STEP 3 : Return back Application back ONLY to Personal Info page.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 3 : Return back Application back ONLY to Personal Info page.', function() {	
				//--- [Back] on Payments page
				CXLib.keyInPaymentReviewFor({'Control' : Structures.PaymentReview.Back});
				
				//--- Validate Facilities Page here
				
				//--- [Back] on Facilities page
				CXLib.keyInFacilitiesFor({'Control' : Structures.Facilities.Back});
				
				//--- Validate Dependents page here
				
				//--- [Back] on Dependents page
				CXLib.keyInDependentsFor({'Control' : Structures.Dependents.Back});
				
				//--- Validate Personal Information page here
			});
			
			/*
			*  CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 : Edit applicant information.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 : Edit applicant information.', function() {
				CXLib.validate({'Page': Structures.Pages.PersonalInformation, 
								'ValidateFor': Structures.Validators.Summary,
								'Control' : Structures.PlanSummary.All,
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Dependents Page : Edit Dependents.
			*/
			for (var idependent = 0; idependent < applicant.PurchaseMade.Dependents.length; idependent++)
			{
				(function (dependent) {					

					it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 2 Dependents Page : Edit Dependents - ' + dependent.Relationship + ' ' + dependent.Name.First, function() {
						CXLib.validate({'Page': Structures.Pages.Dependents, 
										'ValidateFor': Structures.Validators.Summary,
										'Control' : Structures.PlanSummary.ValidateAll,
										'DataCSS' : applicant.PurchaseMade.Plan});
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Facilities Page : Validate Facilities page is displayed.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Facilities Page : Validate Facilities page is displayed.', function() {	
				//--- [Next] on Dependents page
				CXLib.keyInDependentsFor({'Control' : Structures.Dependents.Next});
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Facilities Page : Select a facility.
			*/
			for (var ifacility = 0; ifacility < applicant.PurchaseMade.Facilities.Identifiers.length; ifacility++)
			{
				(function (facility) {
					it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Facilities Page : Select a facility at location(' + ifacility + ')', function() {	
						CXLib.keyInFacilitiesFor({'Control' : Structures.Facilities.Facility,
												  'DataCSS' : facility,
												  'Indice' : ifacility});
						CXLib.keyInFacilitiesFor({'Control' : Structures.Facilities.Next});
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Payments Page : Enter payment details and purchase plan.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Payments Page : Enter payment details and purchase plan.', function() {
				CXLib.validate({'Page': Structures.Pages.PaymentReceipt, 
								'ValidateFor': Structures.Validators.Summary,
								'Control' : Structures.PlanSummary.ValidateAll,
								'DataCSS' : applicant.PurchaseMade.Plan});		
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Receipts Page : Validate Purchase Receipt Summary information.
			*/
			it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Receipts Page : Validate Purchase Receipt Summary information.', function() {	
			...
			/*
			*	CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Receipts Page : Validate Purchase Receipt Dependents information.
			*/
			for (var idependent = 0; idependent < applicant.PurchaseMade.Facilities.Identifiers.length; idependent++)
			{
				(function (dependent) {
					
					it('CX : CXINIT-163 : End To End : SCENARIO 1 : STEP 4 Receipts Page : Validate Purchase Receipt Dependents information - (Dependent ['+idependent+']).', function() {										
						CXLib.validate({'Page' : Structures.Pages.ApplicationReceipt,
