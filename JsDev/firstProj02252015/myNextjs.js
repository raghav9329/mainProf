...
function countItOut(){
 var count = 1;
 var loopHowMany = document.getElementById('myInputBox').value;
 var bodyElement = document.body;

 document.write(bodyElement.innerHTML = bodyElement.innerHTML + "<br/>" +  "Starting Loop as non zero based" + "<br/>");
 while (count <= loopHowMany){
...
/* The following is expiremental   */
/* Initially I'm not finding this works    */
function sleep_a(milliseconds) {
	  var start = new Date().getTime();
	  for (var i = 0; i < 1e7; i++) {
	   document.write( " . ");
	    // Question: where is milliseconds initialized ?
